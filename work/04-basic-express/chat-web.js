    ...
    return `
     <div class="outgoing">
        <form action="/chat" method="post">
          <input type="hidden" name="username" value="QinjianSu">
          <label for="to-send">Message: 
            <input id="to-send" name="text" class="to-send" value="" placeholder="Enter message to send"/>
          </label>
